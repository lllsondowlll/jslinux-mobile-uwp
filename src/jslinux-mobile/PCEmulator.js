function set_hard_irq_wrapper(irq)
{
    this.hard_irq = irq;
}
function return_cycle_count()
{
...
PCEmulator.prototype.timer_func = function ()
{
    ...
    {
        PC.pit.update_irq(); exit_status = cpu.exec(Ncycles - cpu.cycle_count); if (exit_status == 256)
        {
            if (PC.reset_request)
            {
                do_reset = true; break;
...
{
    var i, readw, writew; this.ioport_readb_table = new Array();
...
PCEmulator.prototype.st8_port = function (port_num, x)
{
    this.ioport_writeb_table[port_num & (1024 - 1)](port_num, x);
};

PCEmulator.prototype.st16_port = function (port_num, x)
{
    this.ioport_writew_table[port_num & (1024 - 1)](port_num, x);
};

PCEmulator.prototype.st32_port = function (port_num, x)
{
