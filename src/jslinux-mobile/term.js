...
Term.prototype.open = function () {
    ...
    document.writeln('<table width="100%" border="0" cellspacing="0" cellpadding="0" contenteditable="true" id="consotab" autocapitalize="off" autocorrect="off" spellcheck="false" onclick="focusFirst()"><tr id="cursor"><td><input type="text" id="holder"></td></tr>');
    for (y = 0; y < this.h; y++) {
        document.writeln('<tr><td autocapitalize="off" autocorrect="off" class="term" id="tline' + y + '"></td></tr>');
    }
